    ...
    <article class="f-denuncia">
        ...
        <div class="container">
            ...
            <div class="table-responsive"> 
                <table id="resultados" clas="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>Departamento</th>
                    ...
                    <tbody>
                        <?php
                        $conn = abrir();
                        $sql = "SELECT D.ID, D.DEPARTAMENTO, D.CIUDAD, D.DIRECCION, D.NOMBREIMPLICADO, D.FECHACREACION, D.ESTADO, D.DENUNCIA, DT.NOMBRE AS DELITO "
                                . "FROM DENUNCIA D "
                                . "INNER JOIN DELITO DT ON DT.ID = D.IDDELITO";
                        $result = mysqli_query($conn, $sql);
                        while ($row = mysqli_fetch_array($result)) {
                            echo "<tr>";
                                    echo "<td>".$row['ID']."</td>"."<td>".$row['DEPARTAMENTO']."</td>"."<td>".$row['CIUDAD']."</td>"."<td>".$row['DELITO']."</td>"."<td>".$row['DIRECCION']."</td>"."<td>".$row['NOMBREIMPLICADO']."</td>"."<td>Pendiente</td>"."<td>".$row['FECHACREACION']."</td>";
                            echo "</tr>";
                        }
                        cerrar($conn);
                        ?>
